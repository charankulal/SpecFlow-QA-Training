...
namespace SpecFlowProject1.Features
{
    ...
    [NUnit.Framework.DescriptionAttribute("TestLoginWithParameters")]
    [NUnit.Framework.CategoryAttribute("Sanity")]
    public partial class TestLoginWithParametersFeature
    {
...
#line 1 "TestLoginWithParameters.feature"
#line hidden
        ...
        public virtual void FeatureSetup()
        {
            ...
            TechTalk.SpecFlow.FeatureInfo featureInfo = new TechTalk.SpecFlow.FeatureInfo(new System.Globalization.CultureInfo("en-US"), "Features", "TestLoginWithParameters", "Feature to test login functionality with parameters", ProgrammingLanguage.CSharp, featureTags);
...
#line hidden
        ...
        [NUnit.Framework.TestAttribute()]
        [NUnit.Framework.DescriptionAttribute("Verify login with parameters")]
        [NUnit.Framework.TestCaseAttribute("tom", "Harry", null)]
        [NUnit.Framework.TestCaseAttribute("jerry", "Mathew", null)]
        public void VerifyLoginWithParameters(string username, string password, string[] exampleTags)
        {
            string[] tagsOfScenario = exampleTags;
            System.Collections.Specialized.OrderedDictionary argumentsOfScenario = new System.Collections.Specialized.OrderedDictionary();
            argumentsOfScenario.Add("username", username);
            argumentsOfScenario.Add("password", password);
            TechTalk.SpecFlow.ScenarioInfo scenarioInfo = new TechTalk.SpecFlow.ScenarioInfo("Verify login with parameters", null, tagsOfScenario, argumentsOfScenario, featureTags);
#line 14
this.ScenarioInitialize(scenarioInfo);
#line hidden
            if ((TagHelper.ContainsIgnoreTag(tagsOfScenario) || TagHelper.ContainsIgnoreTag(featureTags)))
